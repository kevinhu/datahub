...
def init_glue_events_rule(events_client: boto3.client):
    role_arn = events_client.get_role(RoleName="DataHubIngestionLambdas")["Role"]["Arn"]
...
def init_sagemaker_events_rule(events_client: boto3.client):
    role_arn = events_client.get_role(RoleName="DataHubIngestionLambdas")["Role"]["Arn"]
