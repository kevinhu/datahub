    ...
    extends RecordTemplate
{
     ...
     * @see ChartSnapshot.Fields#urn
     */
    public ChartSnapshot setUrn(com.linkedin.common.urn.ChartUrn value, SetMode mode) {
    ...
    public ChartAspectArray getAspects(GetMode mode) {
        return obtainWrapped(FIELD_Aspects, ChartAspectArray.class, mode);
    }
    ...
    public ChartAspectArray getAspects() {
        return obtainWrapped(FIELD_Aspects, ChartAspectArray.class, GetMode.STRICT);
    }
     ...
     * @see ChartSnapshot.Fields#aspects
     */
    public ChartSnapshot setAspects(ChartAspectArray value, SetMode mode) {
        putWrapped(FIELD_Aspects, ChartAspectArray.class, value, mode);
        return this;
    }
    ...
    public ChartSnapshot setAspects(
        ...
        putWrapped(FIELD_Aspects, ChartAspectArray.class, value, SetMode.DISALLOW_NULL);
        return this;
    }
    ...
    {
        return ((ChartSnapshot) super.clone());
    }
    ...
    public ChartSnapshot copy()
        throws CloneNotSupportedException
    {
        return ((ChartSnapshot) super.copy());
    }
