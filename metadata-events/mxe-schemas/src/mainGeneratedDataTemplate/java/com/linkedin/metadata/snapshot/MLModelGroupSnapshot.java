    ...
    extends RecordTemplate
{
     ...
     * @see MLModelGroupSnapshot.Fields#urn
     */
    public MLModelGroupSnapshot setUrn(com.linkedin.common.urn.Urn value, SetMode mode) {
    ...
    public MLModelGroupAspectArray getAspects(GetMode mode) {
        return obtainWrapped(FIELD_Aspects, MLModelGroupAspectArray.class, mode);
    }
    ...
    public MLModelGroupAspectArray getAspects() {
        return obtainWrapped(FIELD_Aspects, MLModelGroupAspectArray.class, GetMode.STRICT);
    }
     ...
     * @see MLModelGroupSnapshot.Fields#aspects
     */
    public MLModelGroupSnapshot setAspects(MLModelGroupAspectArray value, SetMode mode) {
        putWrapped(FIELD_Aspects, MLModelGroupAspectArray.class, value, mode);
        return this;
    }
    ...
    public MLModelGroupSnapshot setAspects(
        ...
        putWrapped(FIELD_Aspects, MLModelGroupAspectArray.class, value, SetMode.DISALLOW_NULL);
        return this;
    }
    ...
    {
        return ((MLModelGroupSnapshot) super.clone());
    }
    ...
    public MLModelGroupSnapshot copy()
        throws CloneNotSupportedException
    {
        return ((MLModelGroupSnapshot) super.copy());
    }
