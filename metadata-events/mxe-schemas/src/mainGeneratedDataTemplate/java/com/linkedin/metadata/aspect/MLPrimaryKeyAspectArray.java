    ...
    extends WrappingArrayTemplate<MLPrimaryKeyAspect>
{
    ...
    {
        return ((MLPrimaryKeyAspectArray) super.clone());
    }
    ...
    public MLPrimaryKeyAspectArray copy()
        throws CloneNotSupportedException
    {
        return ((MLPrimaryKeyAspectArray) super.copy());
    }
