    ...
    extends RecordTemplate
{
    ...
    public Consumes(DataMap data) {
        super(data, SCHEMA);
    }

    public static Consumes.Fields fields() {
        return _fields;
    }
     ...
     * @see Consumes.Fields#source
     */
    public Consumes setSource(com.linkedin.common.urn.Urn value, SetMode mode) {
     ...
     * 
     * @see Consumes.Fields#destination
     */
     ...
     * @see Consumes.Fields#destination
     */
    public Consumes setDestination(com.linkedin.common.urn.Urn value, SetMode mode) {
     ...
     * @see Consumes.Fields#destination
     */
    public Consumes setDestination(
        @Nonnull
        com.linkedin.common.urn.Urn value) {
    ...
    {
        return ((Consumes) super.clone());
    }

    @Override
    public Consumes copy()
        throws CloneNotSupportedException
    {
        return ((Consumes) super.copy());
    }
