 ...
 * 
 */
@Generated(value = "com.linkedin.pegasus.generator.JavaCodeUtil", comments = "Rest.li Data Template. Generated from metadata-events/mxe-schemas/src/main/pegasus/com/linkedin/metadata/relationship/EvaluatedOn.pdl.")
public class EvaluatedOn
    extends RecordTemplate
{

    private final static EvaluatedOn.Fields _fields = new EvaluatedOn.Fields();
    private final static RecordDataSchema SCHEMA = ((RecordDataSchema) DataTemplateUtil.parseSchema("namespace com.linkedin.metadata.relationship/**A generic model for the Evaluated-On relationship*/@pairings=[{\"destination\":\"com.linkedin.common.urn.DatasetUrn\",\"source\":\"com.linkedin.common.urn.MLModelUrn\"}]record EvaluatedOn includes/**Common fields that apply to all relationships*/record BaseRelationship{/**Urn for the source of the relationship*/source:{namespace com.linkedin.common@java.class=\"com.linkedin.common.urn.Urn\"typeref Urn=string}/**Urn for the destination of the relationship*/destination:com.linkedin.common.Urn}{}", SchemaFormatType.PDL));
    ...
    public EvaluatedOn(DataMap data) {
        super(data, SCHEMA);
    }

    public static EvaluatedOn.Fields fields() {
        return _fields;
    }
     ...
     * @see EvaluatedOn.Fields#source
     */
    public EvaluatedOn setSource(com.linkedin.common.urn.Urn value, SetMode mode) {
     ...
     * 
     * @see EvaluatedOn.Fields#destination
     */
     ...
     * @see EvaluatedOn.Fields#destination
     */
    public EvaluatedOn setDestination(com.linkedin.common.urn.Urn value, SetMode mode) {
     ...
     * @see EvaluatedOn.Fields#destination
     */
    public EvaluatedOn setDestination(
        @Nonnull
        com.linkedin.common.urn.Urn value) {
    ...
    @Override
    public EvaluatedOn clone()
        throws CloneNotSupportedException
    {
        return ((EvaluatedOn) super.clone());
    }

    @Override
    public EvaluatedOn copy()
        throws CloneNotSupportedException
    {
        return ((EvaluatedOn) super.copy());
    }
