    ...
    extends WrappingArrayTemplate<MLFeatureAspect>
{
    ...
    {
        return ((MLFeatureAspectArray) super.clone());
    }
    ...
    public MLFeatureAspectArray copy()
        throws CloneNotSupportedException
    {
        return ((MLFeatureAspectArray) super.copy());
    }
