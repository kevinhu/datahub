 ...
 * 
 */
@Generated(value = "com.linkedin.pegasus.generator.JavaCodeUtil", comments = "Rest.li Data Template. Generated from metadata-events/mxe-schemas/src/main/pegasus/com/linkedin/metadata/relationship/BaseRelationship.pdl.")
public class BaseRelationship
    extends RecordTemplate
{

    private final static BaseRelationship.Fields _fields = new BaseRelationship.Fields();
    private final static RecordDataSchema SCHEMA = ((RecordDataSchema) DataTemplateUtil.parseSchema("namespace com.linkedin.metadata.relationship/**Common fields that apply to all relationships*/record BaseRelationship{/**Urn for the source of the relationship*/source:{namespace com.linkedin.common@java.class=\"com.linkedin.common.urn.Urn\"typeref Urn=string}/**Urn for the destination of the relationship*/destination:com.linkedin.common.Urn}", SchemaFormatType.PDL));
    ...
    public BaseRelationship(DataMap data) {
        super(data, SCHEMA);
    }

    public static BaseRelationship.Fields fields() {
        return _fields;
    }
     ...
     * 
     * @see BaseRelationship.Fields#source
     */
     ...
     * @see BaseRelationship.Fields#source
     */
    public BaseRelationship setSource(com.linkedin.common.urn.Urn value, SetMode mode) {
     ...
     * @see BaseRelationship.Fields#source
     */
    public BaseRelationship setSource(
        @Nonnull
     ...
     * 
     * @see BaseRelationship.Fields#destination
     */
     ...
     * @see BaseRelationship.Fields#destination
     */
    public BaseRelationship setDestination(com.linkedin.common.urn.Urn value, SetMode mode) {
     ...
     * @see BaseRelationship.Fields#destination
     */
    public BaseRelationship setDestination(
        @Nonnull
        com.linkedin.common.urn.Urn value) {
    ...
    @Override
    public BaseRelationship clone()
        throws CloneNotSupportedException
    {
        return ((BaseRelationship) super.clone());
    }

    @Override
    public BaseRelationship copy()
        throws CloneNotSupportedException
    {
        return ((BaseRelationship) super.copy());
    }
