    ...
    extends RecordTemplate
{
     ...
     * @see MLPrimaryKeySnapshot.Fields#urn
     */
    public MLPrimaryKeySnapshot setUrn(com.linkedin.common.urn.Urn value, SetMode mode) {
    ...
    public MLPrimaryKeyAspectArray getAspects(GetMode mode) {
        return obtainWrapped(FIELD_Aspects, MLPrimaryKeyAspectArray.class, mode);
    }
    ...
    public MLPrimaryKeyAspectArray getAspects() {
        return obtainWrapped(FIELD_Aspects, MLPrimaryKeyAspectArray.class, GetMode.STRICT);
    }
     ...
     * @see MLPrimaryKeySnapshot.Fields#aspects
     */
    public MLPrimaryKeySnapshot setAspects(MLPrimaryKeyAspectArray value, SetMode mode) {
        putWrapped(FIELD_Aspects, MLPrimaryKeyAspectArray.class, value, mode);
        return this;
    }
    ...
    public MLPrimaryKeySnapshot setAspects(
        ...
        putWrapped(FIELD_Aspects, MLPrimaryKeyAspectArray.class, value, SetMode.DISALLOW_NULL);
        return this;
    }
    ...
    {
        return ((MLPrimaryKeySnapshot) super.clone());
    }
    ...
    public MLPrimaryKeySnapshot copy()
        throws CloneNotSupportedException
    {
        return ((MLPrimaryKeySnapshot) super.copy());
    }
