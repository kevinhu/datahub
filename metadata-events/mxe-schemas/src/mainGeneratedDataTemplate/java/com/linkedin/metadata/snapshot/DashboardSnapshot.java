    ...
    extends RecordTemplate
{
     ...
     * @see DashboardSnapshot.Fields#urn
     */
    public DashboardSnapshot setUrn(com.linkedin.common.urn.DashboardUrn value, SetMode mode) {
    ...
    public DashboardAspectArray getAspects(GetMode mode) {
        return obtainWrapped(FIELD_Aspects, DashboardAspectArray.class, mode);
    }
    ...
    public DashboardAspectArray getAspects() {
        return obtainWrapped(FIELD_Aspects, DashboardAspectArray.class, GetMode.STRICT);
    }
     ...
     * @see DashboardSnapshot.Fields#aspects
     */
    public DashboardSnapshot setAspects(DashboardAspectArray value, SetMode mode) {
        putWrapped(FIELD_Aspects, DashboardAspectArray.class, value, mode);
        return this;
    }
    ...
    public DashboardSnapshot setAspects(
        ...
        putWrapped(FIELD_Aspects, DashboardAspectArray.class, value, SetMode.DISALLOW_NULL);
        return this;
    }
    ...
    {
        return ((DashboardSnapshot) super.clone());
    }
    ...
    public DashboardSnapshot copy()
        throws CloneNotSupportedException
    {
        return ((DashboardSnapshot) super.copy());
    }
