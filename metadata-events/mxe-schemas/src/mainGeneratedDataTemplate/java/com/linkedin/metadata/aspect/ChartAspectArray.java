    ...
    extends WrappingArrayTemplate<ChartAspect>
{
    ...
    {
        return ((ChartAspectArray) super.clone());
    }
    ...
    public ChartAspectArray copy()
        throws CloneNotSupportedException
    {
        return ((ChartAspectArray) super.copy());
    }
