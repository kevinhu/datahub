    ...
    extends RecordTemplate
{
     ...
     * @see EditableChartProperties.Fields#created
     */
    public EditableChartProperties setCreated(AuditStamp value, SetMode mode) {
     ...
     * @see EditableChartProperties.Fields#lastModified
     */
    public EditableChartProperties setLastModified(AuditStamp value, SetMode mode) {
     ...
     * @see EditableChartProperties.Fields#deleted
     */
    public EditableChartProperties setDeleted(AuditStamp value, SetMode mode) {
     ...
     * @see EditableChartProperties.Fields#description
     */
    public EditableChartProperties setDescription(String value, SetMode mode) {
    ...
    {
        return ((EditableChartProperties) super.clone());
    }
    ...
    public EditableChartProperties copy()
        throws CloneNotSupportedException
    {
        return ((EditableChartProperties) super.copy());
    }
