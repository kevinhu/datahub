    ...
    extends RecordTemplate
{
     ...
     * @see MetadataChangeLog.Fields#auditHeader
     */
    public MetadataChangeLog setAuditHeader(KafkaAuditHeader value, SetMode mode) {
     ...
     * @see MetadataChangeLog.Fields#entityType
     */
    public MetadataChangeLog setEntityType(String value, SetMode mode) {
     ...
     * @see MetadataChangeLog.Fields#entityUrn
     */
    public MetadataChangeLog setEntityUrn(com.linkedin.common.urn.Urn value, SetMode mode) {
     ...
     * @see MetadataChangeLog.Fields#entityKeyAspect
     */
    public MetadataChangeLog setEntityKeyAspect(GenericAspect value, SetMode mode) {
     ...
     * @see MetadataChangeLog.Fields#changeType
     */
    public MetadataChangeLog setChangeType(ChangeType value, SetMode mode) {
     ...
     * @see MetadataChangeLog.Fields#aspectName
     */
    public MetadataChangeLog setAspectName(String value, SetMode mode) {
     ...
     * @see MetadataChangeLog.Fields#aspect
     */
    public MetadataChangeLog setAspect(GenericAspect value, SetMode mode) {
     ...
     * @see MetadataChangeLog.Fields#systemMetadata
     */
    public MetadataChangeLog setSystemMetadata(SystemMetadata value, SetMode mode) {
    ...
    public GenericAspect getPreviousAspectValue(GetMode mode) {
        return obtainWrapped(FIELD_PreviousAspectValue, GenericAspect.class, mode);
    }
    ...
    public GenericAspect getPreviousAspectValue() {
        return obtainWrapped(FIELD_PreviousAspectValue, GenericAspect.class, GetMode.STRICT);
    }
     ...
     * @see MetadataChangeLog.Fields#previousAspectValue
     */
    public MetadataChangeLog setPreviousAspectValue(GenericAspect value, SetMode mode) {
        putWrapped(FIELD_PreviousAspectValue, GenericAspect.class, value, mode);
        return this;
    }
    ...
    public MetadataChangeLog setPreviousAspectValue(
        @Nonnull
        GenericAspect value) {
        putWrapped(FIELD_PreviousAspectValue, GenericAspect.class, value, SetMode.DISALLOW_NULL);
        return this;
    }
    ...
    public SystemMetadata getPreviousSystemMetadata(GetMode mode) {
        return obtainWrapped(FIELD_PreviousSystemMetadata, SystemMetadata.class, mode);
    }
    ...
    public SystemMetadata getPreviousSystemMetadata() {
        return obtainWrapped(FIELD_PreviousSystemMetadata, SystemMetadata.class, GetMode.STRICT);
    }
     ...
     * @see MetadataChangeLog.Fields#previousSystemMetadata
     */
    public MetadataChangeLog setPreviousSystemMetadata(SystemMetadata value, SetMode mode) {
        putWrapped(FIELD_PreviousSystemMetadata, SystemMetadata.class, value, mode);
        return this;
    }
    ...
    public MetadataChangeLog setPreviousSystemMetadata(
        @Nonnull
        SystemMetadata value) {
        putWrapped(FIELD_PreviousSystemMetadata, SystemMetadata.class, value, SetMode.DISALLOW_NULL);
        return this;
    }
    ...
    {
        return ((MetadataChangeLog) super.clone());
    }
    ...
    public MetadataChangeLog copy()
        throws CloneNotSupportedException
    {
        return ((MetadataChangeLog) super.copy());
    }
